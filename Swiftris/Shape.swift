...
class Shape: Hashable, Printable {
    ...
    final func initializeBlocks() {
        if let blockRowColumnTranslations = blockRowColumnPositions[orientation] {
            for i in 0..<blockRowColumnTranslations.count {
                ...
                let blockCol = column + blockRowColumnTranslations[i].columnDiff
    ...
    final class func random(startingCol:Int, startingRow:Int) -> Shape {
        ...
        case 2:
            return TShape(column: startingCol, row: startingRow)
        case 3:
            return LShape(column:startingCol, row:startingRow)
        case 4:
            return JShape(column:startingCol, row:startingRow)
        case 5:
            return SShape(column:startingCol, row:startingRow)
        default:
            return ZShape(column:startingCol, row:startingRow)
        }
    }
}
